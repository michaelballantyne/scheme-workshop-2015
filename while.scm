;; Relational interpreter for the While language, extended with 'raise'
...
(define-syntax with-exn
  (syntax-rules ()
    [(_ in out body body* ...)
     (with-exn-g in out (lambda (in out) (fresh () body body* ...)))]))
